...
def newConLayer(input, W, B, pooling=True, activation_function=tf.nn.relu, ksize=[1,2,2,1], strides=[1,1,1,1], index=""):
...
for i in range(num_iterations):
    ...
    feed_dict_train = {X:x_train_batch, Y_labels:y_train_batch, lr:learning_rate, p_keep:0.8, is_test:False, iteration:i}
